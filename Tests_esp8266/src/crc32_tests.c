...
TEST_C(Crc32TestsGroup, data_32) {
    ...
    CHECK_EQUAL_C_UINT(0x91267E8A, crc);
}

TEST_C(Crc32TestsGroup, data_16) {
...
TEST_C(Crc32TestsGroup, empty_data) {
    uint8_t data[] = {};
    uint32_t crc = calc_crc32(CRC32_INIT, data, sizeof(data));
    CHECK_EQUAL_C_UINT(0, crc);
}

TEST_C(Crc32TestsGroup, null_data) {
