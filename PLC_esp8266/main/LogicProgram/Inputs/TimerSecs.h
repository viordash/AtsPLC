...
class TimerSecs : public CommonTimer {
  private:
    ...
    static constexpr uint32_t step_s = 1;
    static constexpr uint32_t faststep_s = 10;
    static constexpr uint32_t min_delay_time_s = 1;
    static constexpr uint32_t max_delay_time_s = 99999;
