...
#include "Display/bitmaps/square_wave_generator_active.h"
...
void SquareWaveGenerator::SetPeriod0(uint32_t period_ms) {
    ...
    ESP_LOGD(TAG_SquareWaveGenerator, "ctor, str_period0:%s", this->str_period0);
}
...
const Bitmap *SquareWaveGenerator::GetCurrentBitmap(LogicItemState state) {
    switch (state) {
        ...
        default:
            return &SquareWaveGenerator::bitmap_passive;
    }
}
...
void SquareWaveGenerator::SelectPrior() {
    ESP_LOGI(TAG_SquareWaveGenerator, "SelectPrior");
...
void SquareWaveGenerator::SelectNext() {
    ESP_LOGI(TAG_SquareWaveGenerator, "SelectNext");
...
void SquareWaveGenerator::Change() {
    ESP_LOGI(TAG_SquareWaveGenerator, "Change");
    switch (editing_property_id) {
